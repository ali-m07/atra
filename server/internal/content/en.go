...
func metaEN() SiteMeta {
	return SiteMeta{
		Lang:    string(LangEN),
		Brand:   "Atra",
		Tagline: "Decode the structure of complex systems.",
		Handle:  "@atra_futures",
		Founder: "",
		Tags:    nil,
		...
		HeroLead:      "Atra is a cognitive laboratory for system dynamics and strategic foresight. We study how cities, organizations, and economies actually behave under pressure, then turn that reading into research, education, and practical redesign. If you need structural literacy rather than another surface narrative, this is the door.",
